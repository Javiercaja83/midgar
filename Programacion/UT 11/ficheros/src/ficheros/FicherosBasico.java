...
private static void verDir(){
    ...
    for (int i = 0; i < archivos.length; i++) {
        //NEW FILE ESTA SIMPLEMENTE RECOGIENDO LA REPESENTACION DE LA RUTA ACTUA, NO CREA NADA, NU NNGUN ARCHIVO NUEVO NI NADA
        File f2 = new File(f, archivos[i]);         //DEBUELVE UN BOOLEAN N SALTA DE LINEA, S UN STRING
   ...
   private static void verInf() {
    ...
    try {
     if(f.exists()){
            ...
            System.out.println("hola, error, jeje");
        }
    } 
}
    public static void muestraRutaNIO() {
        ...
        Path currentDir = Paths.get("");
                                               //formato absoluta y en caracteres
